...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it"> 
	<head>
		<title>CPF - Errore</title>
		
		<!-- Info -->
		<meta name="title" content="CPF - Errore"/> 
	...
	<body>
		<div id="header">
			...
			<a href="../en/en_503.php" id="lingua">IT<img src="../img/world.png" alt="" id="mondo"/></a>
		...
		<div id="contenuto">
			...
			<h2 class="info404">Errore 503 - Il server non risponde - Ooops!</h2>
			<p class="info404">Sembra qualcosa non funzioni correttamente.</p>
			<p class="info404">Non ti preoccupare, premi <a href="index.php" id="linkHome">Home</a> o clicca la chiave inglese.</p>
			<p class="info404">Oppure ritenta più tardi. &hearts;</p>
		</div>
		<div id="footer">
