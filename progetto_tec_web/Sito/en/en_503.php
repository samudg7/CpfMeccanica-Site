...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it"> 
	<head>
		<title>CPF - Error</title>
		
		<!-- Info -->
		<meta name="title" content="CPF - Error"/> 
		...
		<meta name="author" content="Benetazzo,  Grandi, Guzzo, Zenere" />
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1.0" />
		
		<!-- Desktop -->
		<link rel="stylesheet" type="text/css" href="../css/base_normal.css"/>
		<link rel="stylesheet" type="text/css" href="../css/error_normal.css"/>
		
		<!-- Mobile -->
		<link rel="stylesheet" type="text/css" href="../css/base_small.css" media="handheld, screen and (max-width: 600px)"/>
		<link rel="stylesheet" type="text/css" href="../css/error_small.css" media="handheld, screen and (max-width: 600px)"/>
		
		<!-- Print -->
		<link rel="stylesheet" type="text/css" href="../css/base_print.css" media="print" />
		<link rel="stylesheet" type="text/css" href="../css/error_print.css" media="print" />
	...
	<body>
		<div id="header">
			...
			<a href="../it/it_503.php" id="lingua">EN<img src="../img/world.png" alt="" id="mondo"/></a>
		...
		<div id="contenuto">
			<a href="../index.php"><img src="../img/404iniziale.png" alt="" id="enkey" onmouseover="this.src='../img/404finale.png'" onmouseout="this.src='../img/404iniziale.png'"/></a>
			<h2 class="info404">Error 503 - Server does not respond - Ooops!</h2>
			<p class="info404">It seems something does not work properly.</p>
			<p class="info404">Do not worry, press <a href="index.php" id="linkHome">Home</a> or click the wrench.</p>
			<p class="info404">Or try again later. &hearts;</p>
		</div>
		<div id="footer">
