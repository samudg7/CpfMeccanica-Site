...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it"> 
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../css/catalogo_normal.css"/>
	...
	<body>
		<div id="header">
			...
			<a href="../it/it_catalogo.php" id="lingua">EN<img src="../img/world.png" alt="" id="mondo"/></a>
		...
		<div id="nav">
			...
			<ul>
				...
				<li class="currentLink"><a href="en_catalogo.php" class="currentLink">Catalog</a></li>
		...
		<div id="breadcrumbs">
			<?php
			if(isset($_GET["art"])){
				echo "<p>You're on: <a href=\"en_catalogo.php\">Home</a> -> <a href=\"en_catalogo.php?cat=".$_GET["cat"]."\">n°".$_GET["cat"]."</a></p>";
			}else{
				echo "<p>You're on: <a href=\"en_catalogo.php\">Catalog</a></p>";
			}
			?>
		</div>
		<div id="contenuto">
